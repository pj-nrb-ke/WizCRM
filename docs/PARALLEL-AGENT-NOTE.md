...
## WizCRM-specific (only for this folder)
...
Web clusters done: **A** (admin settings), **B** (manager workspace). Next optional: **WEB-012** teams CRUD on web, then **Cluster C** (Pro/multi-tenant).
