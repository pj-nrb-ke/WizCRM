...
const SOURCE_META: Record<string, { icon: string; label: string; description: string; color: string; border: string; bg: string }> = {
  ...
  registry_lookup:{ icon: '🗂️', label: 'Global Registry',     description: 'Registry Lookup — 521M+ entities, 309 jurisdictions, wider coverage than OpenCorporates', color: '#065f46', border: '#6ee7b7', bg: '#ecfdf5' },
  job_signals:    { icon: '💼', label: 'Hiring Signal',        description: 'Company actively hiring HR/Finance/IT/Payroll — scaling fast, needs ERP software',  color: '#b45309', border: '#fcd34d', bg: '#fffbeb' },
